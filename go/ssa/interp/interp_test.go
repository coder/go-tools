...
import (
	...
	"go.coder.com/go-tools/go/ssa/interp"
...
func run(t *testing.T, dir, input string, success successPredicate) bool {
	...
	hint = fmt.Sprintf("To dump SSA representation, run:\n%% go build go.coder.com/go-tools/cmd/ssadump && ./ssadump -test -build=CFP %s\n", strings.Join(inputs, " "))
	...
	hint = fmt.Sprintf("To trace execution, run:\n%% go build go.coder.com/go-tools/cmd/ssadump && ./ssadump -build=C -test -run --interp=T %s\n", strings.Join(inputs, " "))
