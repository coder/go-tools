...
func TestContainingPackage(t *testing.T) {
	...
	exported := packagestest.Export(t, packagestest.GOPATH, []packagestest.Module{
		{Name: "go.coder.com/go-tools/go/buildutil", Files: packagestest.MustCopyFileTree(".")}})
	...
	tests := []Test{
		...
		{gopath, gopath + "/src/go.coder.com/go-tools/go/buildutil/util_test.go",
			"go.coder.com/go-tools/go/buildutil"},
	}
	...
	if runtime.GOOS != "windows" && runtime.GOOS != "plan9" {
		...
		tests = append(tests, []Test{
			{gopath, tmp + "/src/go.coder.com/go-tools/go/buildutil/util_test.go", "go.coder.com/go-tools/go/buildutil"},
			{tmp, gopath + "/src/go.coder.com/go-tools/go/buildutil/util_test.go", "go.coder.com/go-tools/go/buildutil"},
			{tmp, tmp + "/src/go.coder.com/go-tools/go/buildutil/util_test.go", "go.coder.com/go-tools/go/buildutil"},
		}...)
	}
