...
// package go.coder.com/go-tools/refactor/rename, which contains most of
// the implementation.
//
package main // import "go.coder.com/go-tools/cmd/gorename"
...
import (
	...
	"go.coder.com/go-tools/refactor/rename"
)
